...
SHARED: tuple[str, ...] = (
    ...
    "domain/scenarios.py",
    "domain/lookahead_moves.py",
    "domain/lookahead_eval.py",
    "domain/lookahead.py",
    ...
    "domain/providers.py",
    "domain/providers_auto.py",
    "domain/budgeting.py",
    "infra/report_league.py",
    "infra/report_reference.py",
    ...
    "shared/consensus.py",
    "shared/consensus_scope.py",
    "shared/naming.py",
    "shared/result_claim.py",
    "shared/terms.py",
    "domain/alternation.py",
    "domain/barrier_audit.py",
    "strategy/base.py",
    "strategy/loader.py",
    "strategy/thief_brain.py",
    "strategy/thief_brain_geometry.py",
    "strategy/thief_brain_ranking.py",
    "strategy/thief_search.py",
    "strategy/containment.py",
    "strategy/pursuit.py",
    "strategy/police_brain.py",
    "strategy/police_brain_pursuit.py",
    "strategy/police_search.py",
    "strategy/tradeoff.py",
    "strategy/barriers.py",
    "strategy/barriers_win.py",
    "strategy/barriers_score.py",
    "strategy/barriers_geometry.py",
    "strategy/budget.py",
)
