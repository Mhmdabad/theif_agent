...
from thief_agent.shared.appendix_f import TABLE, Status, book_int, book_value
...
class TestBookValueAccessors:
    ...
    def test_domain_defaults_come_from_the_table(self) -> None:
        """The table is authoritative for behaviour, not only validation."""
        from thief_agent.domain.actions import DEFAULT_MAX_BARRIERS
        from thief_agent.domain.outcome import DEFAULT_SURVIVAL_THRESHOLD
        from thief_agent.domain.scoring import BOOK_SCORES, BOOK_TIE_SCORE, Outcome
